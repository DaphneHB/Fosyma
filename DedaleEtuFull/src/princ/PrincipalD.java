...
public class PrincipalD {
	...
	// to launch : change ip & set self-name container
	private static String PLATFORM_HOSTNAME ="132.227.205.25";// "127.0.0.1"; // IP 407 pc fond = 132.227.113.238
	...
	public static void main(String[] args){
		...
		startAgents(agentList);
			...
			if(PLATFORM_isMAIN){
				...
				createAndConnectContainer("MyLocalContainer", PLATFORM_HOSTNAME, PLATFORM_ID, PLATFORM_PORT);
